    ...
    constructor() {
        ...
        this.state = {
            pictures: [{
                ...
                id: 7, img: 'http://exploiteddevorgs.com/wp-content/uploads/2015/04/Passengers.jpg', title: 'Traveling', subtitle: 'Retreat into your own personal oasis, even when surrounded by other travelers. Get some shut eye or cut out the background noise so you can concentrate on your book.', cover: 'personalCover'
            }, {
